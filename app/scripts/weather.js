...
class Weather extends Component {
  ...
  render() {
    const slides = this.state.weather.map((elem, index) => {
      ...
      return (
        <View key={elem.key} >
          <Image source={elem.bg} style={{position: 'absolute'}}/>
          <ScrollView
            ...
            <View style={styles.headInfo}>
              ...
              <Text style={styles.circle}>{elem.circle}</Text>
            </View>
            <View style={{}}>
              <View style={styles.withinDayGeneral} >
                ...
                <View style={styles.withinDayTail}>
                  <Text style={styles.withinDayHigh}>{elem.today.high}</Text>
                    <Text style={elem.night?styles.withinDayLowNight:styles.withinDayLow}>
                      {elem.today.low}
                  </Text>
                </View>
              </View>
